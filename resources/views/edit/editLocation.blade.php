            ...
            <div class="container-fluid">
                ...
                <form method="POST" action="{{ route('location.update', $location->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="information" id="information" class="form-control" value="{{ $location->information }}" required>
                    </div>

                    <button type="submit" class="btn btn-primary float-right">Update Location</button>
                </form>
            </div>
        </div>
    </div>
