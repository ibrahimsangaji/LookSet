        ...
        <div id="content">
            <div class="container-fluid">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Edit Rack</h1>
                </div>
                ...
                <form method="POST" action="{{ route('rack.update', $rack->id) }}">
                    @csrf
                    @method('PUT')

                    <div class="form-group">
                        <label for="explanation">Explanation:</label>
                        <input type="text" name="explanation" id="explanation" class="form-control" value="{{ $rack->explanation }}" required>
                    </div>

                    <button type="submit" class="btn btn-primary float-right">Update Rack</button>
                </form>
            </div>
        </div>
    </div>
