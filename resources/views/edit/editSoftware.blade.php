            ...
            <div class="container-fluid">
                ...
                <form method="POST" action="{{ route('software.update', $software->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" value="{{ $software->name }}" required>
                    </div>

                    <div class="form-group">
                        <label for="information">Information:</label>
                        <input type="text" name="information" id="information" class="form-control" value="{{ $software->information }}" required>
                    </div>

                    <button type="submit" class="btn btn-primary float-right">Update Software</button>
                </form>
            </div>
        </div>
    </div>
