        ...
        <div id="content">
            <div class="container-fluid">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Create Rack</h1>
                </div>
                ...
                <form method="POST" action="{{ route('rack.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="explanation" id="explanation" class="form-control" required>
                    </div>

                    <button type="submit" class="btn btn-primary float-right">Add Rack</button>
                </form>
            </div>
        </div>
    </div>
